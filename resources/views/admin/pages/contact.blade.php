        ...
        <div class="colorlib-table-cell js-fullheight">
          <div class="row no-gutters">
            <div class="col-md-12 text-center">
              <h1 class="mb-4"><a href="index.html" class="logo">Mohammad Yasin Roshani</a></h1>
               <ul>
      ...
      <section class="ftco-section contact-section">
        <div class="container mt-5">
          <div class="row d-flex mb-5 contact-info">
            ...
            <div class="w-100"></div>
            <div class="col-md-3">
              <p><span>Address:</span> Resalat Lane, District NO13, Kabul, Afghanistan</p>
            </div>
            <div class="col-md-3">
              <p><span>Phone:</span> <a href="tel://+93781781844">+93 (0) 781 781 844</a></p>
            </div>
            <div class="col-md-3">
              <p><span>Email:</span> <a href="mailto:yasinroshani@yahoo.com">yasinroshani@yahoo.com</a></p>
            </div>
          ...
          <div class="row block-9">
            ...
            <div class="col-md-6" id="maps"></div>
          </div>
        </div>
      </section>
